...
<div class="portada">
	...
	<p class="text-justify lead">
	    ...
	    de consumir llena de beneficios.<br><br>

        <b>Como funciona:</b><br>
        Para crear nuestros anuncios, es necesario estar registrado o haber iniciado sesión,
        solo podremos editar o eliminar nuestros anuncios, y solo el usuario que tiene privilegios 
        de administrador podrá editar o eliminar cualquier anuncio.<br><br>
